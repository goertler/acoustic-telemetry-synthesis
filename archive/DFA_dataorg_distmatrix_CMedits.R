...
setwd("C:/Users/fish/Desktop/DFA/DFA") #CM
setwd("~/Documents/acoustic-telemetry-synthesis/DFA") #PG
...
## Load detections
temp = list.files(path = "C:/Users/TGrimes/Desktop/detection_files/study-detections",full.names = T, pattern="*.csv") #TG
temp = list.files(path = "C:/Users/fish/Desktop/DFA/DFA/study-detections",full.names = T, pattern="*.csv") # CM
temp = list.files(path = "~/Documents/acoustic-telemetry-synthesis/DFA/study-detections",full.names = T, pattern="*.csv") #PG
...
all_detects <- select(all) # got an error here (PG)
...
write.csv(dfa.jsats13,"JSATS13_DistTravelbyday_mat_v2020.csv", row.names=FALSE)
...
write.csv(dfa.jsats16,"JSATS16_DistTravelbyday_mat_v2020.csv", row.names=FALSE)
...
write.csv(dfa.jsats17,"JSATS17_DistTravelbyday_mat_v2020.csv", row.names=FALSE)
...
ybus<- rename(ybus, TagID=Transmitter) # I get an error (PG)
...
write.csv(dfa.ybus,"ybus_DistTravelbyday_mat_v2020.csv", row.names=FALSE)
